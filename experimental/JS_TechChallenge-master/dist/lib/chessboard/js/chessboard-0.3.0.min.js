...
(function () {
  ...
  function F(f) {
    ...
    for (var b in f)
      if (!0 === f.hasOwnProperty(b)) {
        ...
        (n = !0 !== l(b)) ||
          ((n = f[b]),
          (n = "string" !== typeof n ? !1 : -1 !== n.search(/^[bw][KQRNBP]$/)),
          (n = !0 !== n));
        if (n) return !1;
      }
    return !0;
  ...
  function L(f) {
    ...
    for (var b = "", n = 8, m = 0; 8 > m; m++) {
      for (var l = 0; 8 > l; l++) {
        var r = B[l] + n;
        !0 === f.hasOwnProperty(r)
          ? ((r = f[r].split("")),
            (r = "w" === r[0] ? r[1].toUpperCase() : r[1].toLowerCase()),
            (b += r))
          : (b += "1");
      }
      7 !== m && (b += "/");
  ...
  window.ChessBoard =
    ...
    function (f, b) {
      ...
      function Y(a) {
        ...
        if ("string" === typeof b.pieceTheme)
          return b.pieceTheme.replace(/{piece}/g, a);
      ...
      function ja(a, e, c) {
        function d() {
          ...
          if (
            f === a.length &&
            (G(),
            !0 === b.hasOwnProperty("onMoveEnd") &&
              "function" === typeof b.onMoveEnd)
          )
            b.onMoveEnd(m(e), m(c));
        }
        for (var f = 0, g = 0; g < a.length; g++)
          "clear" === a[g].type &&
            $("#" + s[a[g].square] + " ." + h.piece).fadeOut(b.trashSpeed, d),
            "add" === a[g].type &&
              !0 !== b.sparePieces &&
              $("#" + s[a[g].square])
                .append(D(a[g].piece, !0))
                .find("." + h.piece)
                .fadeIn(b.appearSpeed, d),
            "add" === a[g].type &&
              !0 === b.sparePieces &&
              ia(a[g].piece, a[g].square, d),
            "move" === a[g].type &&
              ha(a[g].source, a[g].destination, a[g].piece, d);
      }
      function ka(a, b) {
        a = a.split("");
      ...
      function G() {
        ...
        for (var a in g)
          !0 === g.hasOwnProperty(a) && $("#" + s[a]).append(D(g[a]));
      }
      function R() {
        x.html(A(u));
        G();
        !0 === b.sparePieces &&
          ("white" === u
            ? (S.html(N("black")), T.html(N("white")))
            : (S.html(N("white")), T.html(N("black"))));
      }
      function O(a) {
        var e = m(g),
          c = m(a),
        ...
        if (d !== f) {
          if (
            !0 === b.hasOwnProperty("onChange") &&
            "function" === typeof b.onChange
          )
            b.onChange(e, c);
          g = a;
        }
      ...
      function U(a, b) {
        for (var c in J)
          if (!0 === J.hasOwnProperty(c)) {
            var d = J[c];
            if (a >= d.left && a < d.left + p && b >= d.top && b < d.top + p)
              return c;
          }
        return "offboard";
      }
      ...
      function ma() {
        function a() {
          ...
          y.css("display", "none");
          if (
            !0 === b.hasOwnProperty("onSnapbackEnd") &&
            "function" === typeof b.onSnapbackEnd
          )
            b.onSnapbackEnd(E, t, m(g), u);
        }
        if ("spare" === t) Z();
        else {
          V();
      ...
      function na(a) {
        ...
        y.animate(e, {
          ...
          complete: function () {
            ...
            y.css("display", "none");
            if (
              !0 === b.hasOwnProperty("onSnapEnd") &&
              "function" === typeof b.onSnapEnd
            )
              b.onSnapEnd(t, a, E);
          },
        });
      ...
      function P(a, e, c, d) {
        if (
          "function" !== typeof b.onDragStart ||
          !1 !== b.onDragStart(a, e, m(g), u)
        ) {
          z = !0;
          E = e;
          t = a;
          ...
          J = {};
          for (var f in s)
            !0 === s.hasOwnProperty(f) && (J[f] = $("#" + s[f]).offset());
          y.attr("src", Y(e)).css({
            display: "",
            position: "absolute",
            left: c - p / 2,
      ...
      function aa(a, e) {
        ...
        if (c !== H) {
          ...
          if ("function" === typeof b.onDragMove)
            b.onDragMove(c, H, t, E, m(g), u);
          H = c;
        }
      }
      function ba(a) {
        ...
        if (
          !0 === b.hasOwnProperty("onDrop") &&
          "function" === typeof b.onDrop
        ) {
          var c = m(g);
          "spare" === t && !0 === l(a) && (c[a] = E);
      ...
      function qa(a) {
        if (!0 === b.draggable) {
          ...
          !0 === l(e) &&
            !0 === g.hasOwnProperty(e) &&
            ((a = a.originalEvent),
            P(e, g[e], a.changedTouches[0].pageX, a.changedTouches[0].pageY));
        }
      }
      function ra(a) {
        if (!0 === b.sparePieces) {
      ...
      function va(a) {
        if (
          !1 === z &&
          !0 === b.hasOwnProperty("onMouseoverSquare") &&
          "function" === typeof b.onMouseoverSquare &&
          ((a = $(a.currentTarget).attr("data-square")), !0 === l(a))
        ) {
          var e = !1;
      ...
      function wa(a) {
        if (
          !1 === z &&
          !0 === b.hasOwnProperty("onMouseoutSquare") &&
          "function" === typeof b.onMouseoutSquare &&
          ((a = $(a.currentTarget).attr("data-square")), !0 === l(a))
        ) {
          var e = !1;
          !0 === g.hasOwnProperty(a) && (e = g[a]);
      ...
      function xa() {
        ...
        !0 === "ontouchstart" in document.documentElement &&
          (x.on("touchstart", "." + h.square, qa),
          v.on("touchstart", "." + h.sparePieces + " ." + h.piece, sa),
          $(window).on("touchmove", ta),
          $(window).on("touchend", ua));
      }
      function ya() {
        v.html(ga());
        x = v.find("." + h.board);
        !0 === b.sparePieces &&
          ((S = v.find("." + h.sparePiecesTop)),
          (T = v.find("." + h.sparePiecesBottom)));
        var a = n();
          ...
          for (var a = !0, b = {}, c = 0; c < arguments.length; c++)
            if (!1 === arguments[c]) a = !1;
              ...
              "string" !== typeof d
                ? (d = !1)
                : ((d = d.split("-")),
                  (d = 2 !== d.length ? !1 : !0 === l(d[0]) && !0 === l(d[1])));
              !0 !== d
                ? r(
                    2826,
                ...
                : ((d = arguments[c].split("-")), (b[d[0]] = d[1]));
            }
          var c = g,
            c = m(c),
            f;
          for (f in b)
            !0 === b.hasOwnProperty(f) &&
              !0 === c.hasOwnProperty(f) &&
              ((d = c[f]), delete c[f], (c[b[f]] = d));
          b = c;
          q.position(b, a);
          return b;
        }
      ...
      q.orientation = function (a) {
        ...
        "white" === a || "black" === a
          ? ((u = a), R())
          : "flip" === a
          ? ((u = "white" === u ? "black" : "white"), R())
          : r(5482, "Invalid value passed to the orientation method.", a);
      };
      q.position = function (a, b) {
        ...
        !0 === Q(a) && (a = K(a));
        if (!0 !== F(a))
          r(6482, "Invalid value passed to the position method.", a);
        else if (!0 === b) {
          var c = g,
            d = a,
            c = m(c),
            ...
            k;
          for (k in d)
            !0 === d.hasOwnProperty(k) &&
              !0 === c.hasOwnProperty(k) &&
              c[k] === d[k] &&
              (delete c[k], delete d[k]);
          for (k in d)
          ...
          for (k in d)
            !0 === d.hasOwnProperty(k) &&
              (f.push({ type: "add", square: k, piece: d[k] }), delete d[k]);
          for (k in c)
            !0 === c.hasOwnProperty(k) &&
              !0 !== h.hasOwnProperty(k) &&
              (f.push({ type: "clear", square: k, piece: c[k] }), delete c[k]);
          ja(f, g, a);
          O(a);
        } else O(a), G();
      };
      q.resize = function () {
        ...
        !0 === b.sparePieces &&
          v.find("." + h.sparePieces).css("paddingLeft", p + ea + "px");
        R();
      };
      q.start = function (a) {
        q.position("start", a);
      ...
      if (
              ...
              if ((a = $.fn))
                if ((a = $.fn.jquery))
                  var a = $.fn.jquery,
                    ...
                    a =
                      !0 ===
                      1e8 * a.major + 1e4 * a.minor + a.patch >=
                        1e8 * b.major + 1e4 * b.minor + b.patch;
            return a
              ? !0
              : (window.alert(
                  "ChessBoard Error 1005: Unable to find a valid version of jQuery. Please include jQuery 1.7.0 or higher on the page.\n\nExiting..."
                ),
                !1);
          })())
      ) {
        ...
        if (
          !0 !== b.hasOwnProperty("pieceTheme") ||
          ("string" !== typeof b.pieceTheme &&
            "function" !== typeof b.pieceTheme)
        )
          b.pieceTheme = "lib/chessboard/img/chesspieces/wikipedia/{piece}.png";
        if (!0 !== b.hasOwnProperty("appearSpeed") || !0 !== w(b.appearSpeed))
          b.appearSpeed = 200;
        if (!0 !== b.hasOwnProperty("moveSpeed") || !0 !== w(b.moveSpeed))
          b.moveSpeed = 200;
        if (
          !0 !== b.hasOwnProperty("snapbackSpeed") ||
          !0 !== w(b.snapbackSpeed)
        )
          b.snapbackSpeed = 50;
        if (!0 !== b.hasOwnProperty("snapSpeed") || !0 !== w(b.snapSpeed))
          b.snapSpeed = 25;
        if (!0 !== b.hasOwnProperty("trashSpeed") || !0 !== w(b.trashSpeed))
          b.trashSpeed = 100;
        !0 === b.hasOwnProperty("position") &&
          ("start" === b.position
            ...
            : !0 === F(b.position)
            ? (g = m(b.position))
            : r(7263, "Invalid value passed to config.position.", b.position));
        W = !0;
      }
      W && (I(), ya(), xa());
      return q;
